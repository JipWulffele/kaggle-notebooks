...
- **Notebook:** [`burining-calories-a-model-comparison-ridge-ensem.ipynb`](./notebooks/predict_calorie_expenditure/burning-calories-a-model-comparison-ridge-ensem.ipynb)
